...
Example of our used annotations and their format could be found here: `./sprout-emergence-prediction/models/segmentation_model/annotations`
...
Example of our used annotations and their format could be found here: `./sprout-emergence-prediction/models/object_detection_model/detect_annotations`
...
We understand that it can be difficult to know exactly what format annotations must be written in. For easier understanding an example of our used annotations and their format could be found here: `./sprout-emergence-prediction/models/prediction_model/annotation/`
